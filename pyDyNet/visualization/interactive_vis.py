...
def _convert_input_data(nodes, edges):
    """
...
def vis_interactive(node_df, edge_df, out_filename='output/interactive_graph_out', xsize=800, ysize=800):
    ...
    G = _convert_input_data(node_df, edge_df)
    int_vis_out = _draw_interactive_network(G, outfile=out_filename, xsize=xsize, ysize=ysize)
